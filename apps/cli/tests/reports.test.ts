      ...
      const events: CachedEventRecord[] = [
        {
          ...
          helper_response: {
            url: 'https://lu.ma/future',
            canonical_url: 'https://lu.ma/future',
            final_url: 'https://lu.ma/future',
            title: 'Future Event',
            starts_at: '2026-04-05T18:00:00.000Z',
            location_type: 'in_person',
            price_type: 'free',
            registration_status: 'open',
            organizer_names: ['Founders Bay'],
            speaker_names: [],
            popularity_signals: ['120 attending'],
        ...
        },
        {
          ...
          source_message_ids: [],
          helper_response: {
            url: 'https://lu.ma/past',
            canonical_url: 'https://lu.ma/past',
            final_url: 'https://lu.ma/past',
            title: 'Past Event',
